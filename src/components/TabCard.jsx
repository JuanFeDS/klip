    ...
    <div className="group relative">
      <div className="relative">
        <a
          ...
          className="block p-4 pr-12 rounded-xl shadow bg-white dark:bg-gray-800 hover:shadow-md transition-all duration-200 border border-transparent hover:border-primary/20"
        >
        ...
        <div className="absolute top-3 right-3 flex flex-col gap-1 opacity-0 group-hover:opacity-100 transition-opacity bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-1 rounded-lg">
          <button
            onClick={(e) => {
              e.preventDefault();
              e.stopPropagation();
